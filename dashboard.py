...
class ISM:
    def __init__(self,root):
       ...
       #===btn_logout===
       btn_logout=Button(self.root,text="Logout",font=("time new romans",15,"bold"),bg="yellow",cursor="hand2").place(x=1150,y=10,height=50,width=150)
       #===clock====
       ...
       btn_Package=Button(LeftMenu,text="Package",image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("time new romans",20,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
       ...
       btn_Exit=Button(LeftMenu,text="Exit",image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("time new romans",20,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
